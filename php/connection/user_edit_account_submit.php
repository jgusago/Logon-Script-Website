...
$stmt = $db->prepare("UPDATE tbl_user SET userid='$userid', name='$name', department='$department', position='$position', role='$role', password=md5($_POST['password']) WHERE id='$get_id'");
$stmt->execute(array());
