...
foreach($result as $row)
{
    ...
    echo "#$hostname|User: ~Employee ID:$user|$ip_address|iMonitor Services:$status~Connection Status:$status1|$remarks|$agent_version|$scan_time|||button`btn~btn-primary`onClick:COMPLISTupdate(\"$hostname\", \"$user\",\"$remarks\", \"$tabledata\",\"$parent\",\"$id\")`Details";
