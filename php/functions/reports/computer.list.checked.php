...
$query = "INSERT logonscript.tbl_history (transact_date, transact_name, transact_details, user_id) VALUES (NOW(), 'Computer List Checked', 'Hostname: $hostname / Agent Version: $version / Remarks: $remarks', '$id')";
if($db->query($query)){
  echo "success|";
