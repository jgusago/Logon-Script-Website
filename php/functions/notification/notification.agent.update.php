...
foreach($result as $row){
  ...
  echo "Processor|Operating System|System Type|Disk Serial|MAC Address|Manufacturer|Motherboard Product|Agent Version";
...
echo "#$processor|$OS|$system_type|$serial|$macaddress|$manufacturer|$model|input`form-control`id:CMPLISTdtlsagentversion~type:text~placeholder:$version~onkeyup:CMPLISTdtlsremarksupdate(\"$version\",\"CMPLISTdtlsagentversion\")`$version";
