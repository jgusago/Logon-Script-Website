...
if(!isset($error)){ 
        ...
        if ($row_count > 0){
            echo "<script>alert('User ID is already exist!'); window.location='../../../.superadmin.html'</script>";
        }
else
    {
        ...
        ($db->query($sql));
        echo "<script>alert('User Account Successfully Saved!'); window.location='../../../.superadmin.html'</script>";
    }
}
?>