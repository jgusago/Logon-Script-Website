...
<body>
    ...
    <div class="panel with-nav-tabs panel-default" style="width: 89.5%; position: fixed; margin-top:8px; margin-left: 252px;">
        <div class="panel-heading">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab0default" data-toggle="tab">Computer Logs</a></li>
                <li><a href="#tab1default" data-toggle="tab">Computer List</a></li>
        ...
        <div class="panel-body">
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="tab1default">
                    <div class="pane pane--table1" style="padding-right: 55px;">
                        <div class="col-md-3">
                            <input type="text" name="from_date" class="form-control" id="from_date1" placeholder="From Date"> 
                        </div>
                        <div class="col-md-3">
                            <input type="text" name="to_date" class="form-control" id="to_date1" placeholder="To Date"> 
                        </div>
                        <div class="col-md-3">
                            <select name="department" id="department" class="form-control">
                                <option value="" selected>--All department--</option>
