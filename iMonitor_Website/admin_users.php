            ...
            <table class="table table-bordered" style="position: fixed; margin-left:12px; margin-top:240px; margin-bottom:10px; width:87%">
                ...
                <tbody class="table-users">
                	...
                	<tr>
                        ...
                        <td><a href="#editUser" data-toggle="modal"><button class="btn btn-primary" <?php echo '?id='.$id; ?>>Edit Record</button></a></td>
					</tr>
					<?php } ?>
            	</tbody>
            </table>
					...
					<div class="body">
						<form style="padding:10px;">
							<table class="modal-form">
								<tr>
									<td><b>ID Number:</b></td>
									<td><input type="text" id="userid" name="userid" value="<?php echo $row['userid']; ?>" required placeholder="User ID"><?php } ?></td>
								</tr>
								<tr>
									<td><b>Name:</b></td>
