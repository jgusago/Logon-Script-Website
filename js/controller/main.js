...
function ACCTedit()
{
  ...
  createnewElement(button, divfooter.newelement, "input", ["btn", "btn-success"], ["value:Register", "type:submit", "id:btnRegsiter", "name: btnRegister"], "");
}
...
createnewElement(rightdiv, divvalue.newelement, "div", ["col-sm-12","col-md-6","d-flex","flex-row-reverse"], [], "");
  ...
  createSelection(select, subrdiv.newelement, [], ["id:CMPLISTdtlsremarks","onChange:CMPLISTdtlsremarksupdate(\""+remarks+"\",\"CMPLISTdtlsremarks\")"], ["Active:Active","Resigned:Resigned","Transferred:Transferred"," Old PC name:Old PC name"]);
  //add value
