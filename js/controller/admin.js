...
function ACCTedit(userid, name, department, position, role, status, tabledata, grandparent, linkid)
{
  ...
  createnewElement(inputpwd, divbody6.newelement, "input", ["form-control"], ["type:text", "id:passwordupdate", "disabled:true", "value:Aa123456"], "");

  createnewElement(divbody6, cb, "div", ["md-form", "mb-3"], [], "");
  createnewElement(label6, divbody6.newelement, "label", [],["id:editLbl"],"");
  createnewElement(inputpwd, divbody6.newelement, "input", ["form-control"], ["type:text", "id:passwordmirror"], "");

  createnewElement(divbody7, cb, "div", ["md-form", "mb-3"], ["id:resetpw"], "");
  createnewElement(label7, divbody7.newelement, "label", [],[],"");
  createnewElement(resetpwd, label7.newelement, "input", [], ["type:checkbox", "id:resetPass", "onclick:passmirrorvalue()"], "");
