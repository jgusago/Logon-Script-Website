...
function ACCTedit(userid, name, department, position, role, status, tabledata)
{
  OVERLAYenable();
  ...
  createnewElement(select1, divbody3.newelement, "select", ["form-control"], ["name:role", "id:role2", "required:true", "value:"+role], "");
  ...
  createnewElement(select2, divbody4.newelement, "select", ["form-control"], ["name:status", "id:status2", "required:true", "value:"+status], "");
